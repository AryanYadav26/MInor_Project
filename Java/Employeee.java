...
class employee
{
String name; int empid; int salary; employee()
{
}
employee(String n,int e,int s)
 
{
name=n; empid=e; salary=s;
}
String names()
{
return name;
...
{
double in=(salary*(per_rate/100)); double s=salary+in;
return s;
}
}
...
String n=sc.next(); System.out.println("enter the employee id");
int e=sc.nextInt();		
